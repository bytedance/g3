...
use super::DirectFloatEscaperStats;
use crate::auth::UserUpstreamTrafficStats;
use crate::module::http_forward::ArcHttpForwardTaskRemoteStats;

#[derive(Clone)]
pub(super) struct DirectHttpMixedRemoteStats {
    escaper: Arc<DirectFloatEscaperStats>,
    task: ArcHttpForwardTaskRemoteStats,
    others: Vec<ArcHttpForwardTaskRemoteStats>,
}

impl DirectHttpMixedRemoteStats {
    pub(super) fn new(
        escaper: &Arc<DirectFloatEscaperStats>,
        task: &ArcHttpForwardTaskRemoteStats,
    ) -> Self {
        DirectHttpMixedRemoteStats {
...
impl LimitedWriterStats for DirectHttpMixedRemoteStats {

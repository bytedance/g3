    ...
    R: AsyncRead + Unpin,
{
    pub(super) fn new(ups_r: LimitedBufReader<R>) -> Self {
        HttpsPeerHttpForwardReader { inner: ups_r }
    }
...
impl<R> AsyncRead for HttpsPeerHttpForwardReader<R>
where
    R: AsyncRead,
{
    fn poll_read(
...
impl<R> AsyncBufRead for HttpsPeerHttpForwardReader<R>
where
    R: AsyncRead,
{
...
#[async_trait]
impl<R> HttpForwardRead for HttpsPeerHttpForwardReader<R>
where

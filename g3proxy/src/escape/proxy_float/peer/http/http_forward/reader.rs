...
impl<R> AsyncRead for HttpPeerHttpForwardReader<R>
where
    R: AsyncRead,
{
    fn poll_read(
...
impl<R> AsyncBufRead for HttpPeerHttpForwardReader<R>
where
    R: AsyncRead,
{
...
#[async_trait]
impl<R> HttpForwardRead for HttpPeerHttpForwardReader<R>
where

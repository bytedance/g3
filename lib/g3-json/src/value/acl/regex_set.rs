...
impl AclRuleJsonParser for AclRegexSetRuleBuilder {
    #[inline]
...
fn as_regex(value: &Value) -> anyhow::Result<Regex> {
...
pub(crate) fn as_regex_set_rule_builder(value: &Value) -> anyhow::Result<AclRegexSetRuleBuilder> {

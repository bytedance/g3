[![minimum rustc: 1.77](https://img.shields.io/badge/minimum%20rustc-1.77-green?logo=rust)](https://www.whatrustisit.com)
...
- HTTP1/HTTP2/SMTPのICAP適応、サードパーティのセキュリティ製品とシームレスに統合可能
- 優雅なリロード
